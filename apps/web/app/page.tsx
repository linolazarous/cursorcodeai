      ...
      <section className="pt-40 pb-32 text-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 max-w-6xl relative z-10">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto mb-12">
            CursorCode AI is a self-directing AI engineering organization.
      ...
      <section className="py-32 border-t border-border text-center">
        <div className="container mx-auto px-6 max-w-3xl">
          <h2 className="text-6xl font-bold mb-8">
            The Autonomous Engineering Future.
          </h2>

          <Button size="lg" className="h-16 px-16 neon-glow text-xl" asChild>
            <Link href="/auth/signup">
              Start Building on CursorCode AI
            </Link>
          </Button>
        </div>
      </section>
...
function DeployTerminal() {
  const lines = [
    ...
    "Application live at https://app.cursorcode.app",
  ];
